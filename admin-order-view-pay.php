<?php
	...
	$sql = "select * from orders where or_status='Waiting'";
	...
	if(mysqli_num_rows($result) == 0){
		...
		?>
            <tr>
                ...
                <td align="center"><a class="btn" id="checkPay" data-id="<?PHP echo $data['or_id']?>">Check</a></td>
                <td align="center"><a class="btn" id="conPay" data-id="<?PHP echo $data['or_id']?>">Confirm</a></td>
                <td align="center"><a class="btn" id="rejPay" data-id="<?PHP echo $data['or_id']?>">Reject</a></td>
            </tr>
